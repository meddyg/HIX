...
4. El Document Registry resuelve el paciente local a la identidad maestra, la escribe como sujeto del puntero, lo registra a nombre del custodio y responde. Si el paciente no resuelve a una identidad maestra, rechaza la publicación.
