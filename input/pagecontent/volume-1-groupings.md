...
**Document Registry.** Es el Document Registry de MHDS, y es MHDS quien fija sus agrupaciones[^mhds-groupings].
...
| Document Registry | MHDS Document Registry [Authorization, UnContained Reference], MHD Document Recipient [Comprehensive Metadata], MHD Document Responder, PMIR Patient Identity Consumer, mCSD Care Services Selective Consumer, IUA Resource Server [Authorization Server Metadata] |
